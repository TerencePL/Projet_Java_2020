 ...
 */
public class OneCours extends javax.swing.JFrame {
    ...
    public OneCours() {
        ...
        className.setText(cours.getNom());
      
        fillSeances(); //Remplir le tableau avec les étudiants de la classe
    ...
    /**
     *Remplir le tableau avec les seances du cours
     */
    public void fillSeances(){
        
        try {
            
            
            //On r�cup les seances
            ...
            Logger.getLogger(OneCours.class.getName()).log(Level.SEVERE, null, ex);
        }
